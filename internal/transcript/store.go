...
//   - FinishTurn sets EndedAt, Result/Error, SnapshotID, and the final status
...
type Store interface {
	...
	FinishTurn(ctx context.Context, convID, turnID string, res *adapter.Result, snapshotID string, runErr error) (*Turn, error)
